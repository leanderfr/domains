...
<div @class( ['domainCard', 'disabledDomain' => ! $active] ) onclick="window.location = '{{ $href }}'" >
    ...
    <div class='flex w-[200px] flex-row'>
      ...
      <!-- botao editar -->
      @if ($active)
        <a href="{{ route('domains.edit', ['id' => $id]) }}" class='actionButton'  >
            <div>
      ...
      <!-- botao excluir -->
      @if ($active)
        <a href="{{ route('domains.delete', ['id' => $id]) }}" class='actionButton'  >
            <div >
      ...
      @if (! $active)
        ...
        <a href="{{ route('domains.status', ['id' => $id]) }}" class='actionButton'  >
            <div>
